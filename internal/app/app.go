...
import (
	...
	"gitea.chrnv.ru/vanadium23/kompanion/internal/controller/http/opds"
	v1 "gitea.chrnv.ru/vanadium23/kompanion/internal/controller/http/v1"
	"gitea.chrnv.ru/vanadium23/kompanion/internal/controller/http/web"
	"gitea.chrnv.ru/vanadium23/kompanion/internal/controller/http/webdav"
	"gitea.chrnv.ru/vanadium23/kompanion/internal/library"
	"gitea.chrnv.ru/vanadium23/kompanion/internal/stats"
	"gitea.chrnv.ru/vanadium23/kompanion/internal/storage"
	"gitea.chrnv.ru/vanadium23/kompanion/internal/sync"
	"gitea.chrnv.ru/vanadium23/kompanion/pkg/httpserver"
	"gitea.chrnv.ru/vanadium23/kompanion/pkg/logger"
	"gitea.chrnv.ru/vanadium23/kompanion/pkg/postgres"
)
